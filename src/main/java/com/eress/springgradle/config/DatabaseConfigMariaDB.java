package com.eress.springgradle.config;
...
@MapperScan(value = {"com.eress.springgradle.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
@Configuration
public class DatabaseConfigMariaDB {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage("com.eress.springgradle.model");
